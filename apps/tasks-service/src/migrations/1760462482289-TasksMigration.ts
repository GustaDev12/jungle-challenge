...
export class TasksMigration1760462482289 implements MigrationInterface {
    name = 'TasksMigration1760462482289'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "tasks"."tasks_priority_enum_old" AS ENUM('LOW', 'MEDIUM')`);
